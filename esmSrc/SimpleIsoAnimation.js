import { CanvasAnimation } from './CanvasAnimation.js';
	...
	'use strict';
            function SimpleIsoAnimation(source, canvasObject, fromRect, x, y, width, height, scene) {
				CanvasAnimation.call(this,source, canvasObject, fromRect, x, y, width, height);
            ...
            SimpleIsoAnimation.prototype = Object.create(CanvasAnimation.prototype);
