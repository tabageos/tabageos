...
import { GeometricMath } from './GeometricMath.js';
	...
	BlittedTraveler.prototype = Object.create(TravelerSkeleton.prototype);
	Object.assign(BlittedTraveler.prototype, Traveler.prototype);
    BlittedTraveler.prototype.init = function(source, canvasObject, fromRect, x, y, width, height) {
        ...
        this.fromRect = fromRect || new Rectangle(0,0,32,32);
        this.x = x || 0;
        this.y = y || 0;
        this.height = height || 0;
        this.width = width || 0;
        this.travelType = null;
		this.blankRect = new Rectangle();
        this.boundingMethod = BoundMethods.bounceOff;
        this.mass = 10;
        this.avoidSpace = 35;
        this.maxSpeed = 14;
        this.maxForce = 25;
    ...
    BlittedTraveler.prototype.getBlitType = function() {
        var s = BlittedTraveler.JUST_COPY;
        if (this._blitType == 1)
            s = BlittedTraveler.FILL_RECT_THEN_COPY;
        if (this._blitType == 2)
            s = BlittedTraveler.COPY_THEN_COPY;
        return s;
    };
    ...
    BlittedTraveler.prototype.setBlitType = function(toThis) {
        if (toThis == BlittedTraveler.JUST_COPY)
            this._blitType = 0;
        if (toThis == BlittedTraveler.FILL_RECT_THEN_COPY)
            this._blitType = 1;
        if (toThis == BlittedTraveler.COPY_THEN_COPY) {
    ...
    BlittedTraveler.prototype.blit = function(r, p, igf) {
        ...
        if (this._blitType == 1)
            this._canvas.drawRect(this.fromRect, this.fillColor);
        if (this._blitType == 2)
    ...
    BlittedTraveler.prototype.basicDepthSort = function(bt, topCanvas, bottomCanvas, sortRadius, offset) {
        var sorted = false;
        if (GeometricMath.testForPointInCircle(this._pos, sortRadius, bt._pos)) {
