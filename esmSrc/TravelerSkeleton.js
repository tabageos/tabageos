...
import {EventDispatcher} from './EventDispatcher.js';
    ...
    function TravelerSkeleton(x, y, width, height) {
		...
		this.bird = null;
		this._pathIndex = 0;
		this._hp = new MoverPoint();
		this._vp = new MoverPoint();
    ...
    TravelerSkeleton.prototype.separateFromThis = function(mover) {
        var difference;
        var distance;
		distance = MoverPoint.distBetween(this._pos, mover.getPosition());
