...
import {CanvasObject} from './CanvasObject.js';
	...
	CanvasObjectContainer.prototype = Object.create(EventDispatcher.prototype);
    CanvasObjectContainer.prototype.init = function(divID, width, height, rootCanvasObjectContainer, floorColorString) {
        ...
        if (divID) {
            ...
            this.div.setAttribute("style", "position:absolute;width:"+this._w+"px;height:"+this._h+"px;");
			...
			if (floorColorString) {
				this.floor = new CanvasObject(null,this._w,this._h);
    ...
    CanvasObjectContainer.prototype._setUpChild = function(child, indx, x, y) {
        ...
        ele.setAttribute("style", "position:" + (child.canvas ? "absolute" : "relative") + ";z-index:" + indx + ";width:"+child.getWidth()+"px;height:"+child.getHeight()+"px;left:" + x + "px;top:" + y + "px;");
    };
    export { CanvasObjectContainer   };
