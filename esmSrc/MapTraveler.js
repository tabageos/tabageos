...
this.width = width || 0;
		...
		this.destination = new MoverPoint();
    ...
    MapTraveler.prototype = Object.create(TravelerSkeleton.prototype);
    ...
    MapTraveler.prototype.isHeadHitOnMap = function(last, curr, veloc, map,tw,th) {
        ...
        while(bLx < bRx) {
            ...
            cmb = BlitMath.fasterCheckTileValueAt(bLx,bLy,this._mapRows,this._mapColumns,tw,th, this._checkHelper);
			ciy = this._checkHelper.y; cix = this._checkHelper.x;
			tile = this._map[ciy][cix];
            if((this._mt === 0 && tile != 0)  || ( this._mt === 1 && ((tile[0] != 0 || tile[1] != 0)) )) {
                gy = (ciy*th) +th; 
    ...
    MapTraveler.prototype.isRightPushingOnMap = function(last, curr, veloc, map,tw,th) {
        ...
        while(Tpy < Bty) {
            ...
            cmb = BlitMath.fasterCheckTileValueAt(rx,Tpy,this._mapRows,this._mapColumns,tw,th, this._checkHelper);
			ciy = this._checkHelper.y; cix = this._checkHelper.x;
			tile = this._map[ciy][cix];
            if((this._mt === 0 && tile != 0)  || ( this._mt === 1 && ((tile[0] != 0 || tile[1] != 0)) )) {
                gx = (cix*tw) +1-1;
    ...
    MapTraveler.prototype.isLeftPushingOnMap = function(last, curr, veloc, map,tw,th) {
        ...
        while(Tpy < Bty) {
            ...
            cmb = BlitMath.fasterCheckTileValueAt(lx,Tpy,this._mapRows,this._mapColumns,tw,th, this._checkHelper);
			ciy = this._checkHelper.y; cix = this._checkHelper.x;
			tile = this._map[ciy][cix];
            if((this._mt === 0 && tile != 0)  || ( this._mt === 1 && ((tile[0] != 0 || tile[1] != 0)) )) {
                gx = (cix*tw) + tw;
