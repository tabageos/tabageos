...
import { SimpleIsoBox } from './SimpleIsoBox.js';
	...
	'use strict';
            ...
            function SimpleIsoCharacter(source, canvasObject, fromRect, x,y,z,width,height,depth,scene,aWidth,aHeight) {
				...
				SimpleIsoBox.call(this,x,y,z,width,height,depth);
                this.width = width || 0;
				...
				this.potato = null;
                this.scene = scene;
                this.animation = new SimpleIsoAnimation(source, canvasObject, fromRect, x,y,aWidth||width,aHeight||height);
                this.traveler = new Traveler(x,y,width,height);
               
            };
			SimpleIsoCharacter.prototype.constructor = SimpleIsoCharacter;
            SimpleIsoCharacter.prototype = Object.create(MoverSkeleton.prototype);
			Object.assign(SimpleIsoCharacter.prototype, SimpleIsoBox.prototype);
