(function() { 
	...
	BasicCamera.prototype.windowLoopExecuteShake = function() {
		this.shakeInterval = window.setInterval( function(e) {
			if(tabageos.GameSkeleton.game.camera.shakeTime >= -40) {
				tabageos.GameSkeleton.game.camera.executeShake();
			} else {
				tabageos.GameSkeleton.game.camera.executeShake();
				window.clearTimeout(tabageos.GameSkeleton.game.camera.shakeInterval);
			}
		}, 33.3);
	};
